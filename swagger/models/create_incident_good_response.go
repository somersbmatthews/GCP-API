...
func (m *CreateIncidentGoodResponse) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this create incident good response based on context it is used
