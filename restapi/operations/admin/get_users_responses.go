...
/*GetUsersUnauthorized bad authorization token
...
func (o *GetUsersUnauthorized) WithPayload(payload *models.BadResponse) *GetUsersUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users unauthorized response
func (o *GetUsersUnauthorized) SetPayload(payload *models.BadResponse) {
	o.Payload = payload
}
...
func (o *GetUsersNotFound) WithPayload(payload *models.BadResponse) *GetUsersNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users not found response
func (o *GetUsersNotFound) SetPayload(payload *models.BadResponse) {
	o.Payload = payload
}
