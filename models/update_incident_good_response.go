...
func (m *UpdateIncidentGoodResponse) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this update incident good response based on context it is used
